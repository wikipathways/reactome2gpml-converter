...
/**
 * Provides a breadth-first-search (BFS) iterator for elements in a particular
 * Document matching certain element names.
 * 
 * @author leon
 * 
 */
class ElementIterator implements Iterator<Element> {
	...
	public ElementIterator(Document doc,
			Collection<String> interestingElementNames) {
		this.doc = doc;
